from scripts.speech_recognitions import initialize_recognition, recognize_speech, stop_recognition
from scripts.task_manager import add_task, list_tasks, remove_task
from scripts.text_to_speech import initialize_speech_engine, speak
            ...
            if recognized_text:
                ...
                if "hello" in recognized_text.lower():
                    ...
                    try:
                        ...
                        result = remove_task(task_number - 1)  # Convert to zero-based index
                        speak(engine, result)
                    except ValueError:
